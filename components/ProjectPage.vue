<template lang="pug">
  .w-100
    .w-100.min-h-100.top-0.ph2(v-bind:style="{ backgroundColor: $props.post.color }")
      .f-subheadline-ns.f1.white.tl.pt6.mw7-ns.center  {{ $props.post.title }}
      .f2-ns.f3.white.tl.mw7-ns.center.pt3.pb4  {{ $props.post.slogan }}
